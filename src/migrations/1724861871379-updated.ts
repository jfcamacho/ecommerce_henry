...
export class Updated1724861871379 implements MigrationInterface {
    name = 'Updated1724861871379'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(50) NOT NULL, "name" character varying(50) NOT NULL, "password" character varying(80) NOT NULL, "address" character varying(80) NOT NULL, "phone" integer NOT NULL, "isAdmin" boolean NOT NULL DEFAULT false, "country" character varying(50), "city" character varying(50), "adress" text, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
